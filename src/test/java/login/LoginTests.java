...
public class LoginTests extends BaseTests {
    ...
    public void TC_4_Verify_that_user_can_login_with_valid_credentials(){
        LoginTestDataGenerator loginData= new LoginTestDataGenerator();
        LoginPage loginPage= homePage.clickLogin();
        loginPage.setEmailField(loginData.getEmail());
        loginPage.setPasswordField(loginData.getPassword());
